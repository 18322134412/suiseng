...
/// 数据库操作对象
/// </summary>
private CreditsHistoryDAO _dao = new CreditsHistoryDAO();
...
public IEnumerable<CreditsHistory> QueryList(int index, int size=10, object wheres=null, string orderField=null, bool isDesc=false)
{
...
#endregion
#region 查询单个模型实体 +CreditsHistory QuerySingleByWheres(object wheres)
///<summary>
///查询单个模型实体
///</summary>
///<param name="wheres">条件匿名类</param>
