...
namespace Sheep.Controllers
{
    public class commentsController : baseApiController
    {
        ...
        public IHttpActionResult GetComment(string v1, int limit = 10, int page = 0, string where = null, string include = null, string order = null)
        {
            try
            {
        ...
        public IHttpActionResult DeleteComment(string v1, string objectId)
        {
            try
            {
                //表单验证
        ...
        public IHttpActionResult PostComment(string v1,[FromBody]Comment model,bool isReply=false )
        {
            try
            {
